#ifndef uvm_btc_uvm_api_h
#define uvm_btc_uvm_api_h
        ...
        namespace api {
            ...
            public:
                ...
                */
                ...
                virtual UvmStorageValue get_storage_value_from_uvm(lua_State *L, const char *contract_name, const std::string& name, const std::string& flat_map_key, bool is_flat_map);

                virtual UvmStorageValue get_storage_value_from_uvm_by_address(lua_State *L, const char *contract_address, const std::string& name, const std::string& flat_map_key, bool is_flat_map);
