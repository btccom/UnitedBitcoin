#pragma once
#include <fcrypto/bigint.hpp>
#include <fcrypto/openssl.hpp>
...
namespace fcrypto {
  ...
  namespace ecc {
    ...
    typedef fcrypto::sha256                  blind_factor_type;
    typedef fjson::array<char,33>          commitment_type;
    typedef fjson::array<char,33>          public_key_data;
    typedef fcrypto::sha256                  private_key_secret;
    typedef fjson::array<char,65>          public_key_point_data; ///< the full non-compressed version of the ECC point
    typedef fjson::array<char,72>          signature;
    typedef fjson::array<unsigned char,65> compact_signature;
    typedef std::vector<char>           range_proof_type;
    typedef fjson::array<char,78>          extended_key_data;
    typedef fcrypto::sha256                  blinded_hash;
    typedef fcrypto::sha256                  blind_signature;
    ...
    class public_key
    {
        public:
           ...
           ~public_key();
//           bool verify( const fcrypto::sha256& digest, const signature& sig );
           ...
           public_key( const compact_signature& c, const fcrypto::sha256& digest, bool check_canonical = true );

           public_key child( const fcrypto::sha256& offset )const;

           bool valid()const;
           /** Computes new pubkey = generator * offset + old pubkey ?! */
//           public_key mult( const fcrypto::sha256& offset )const;
           /** Computes new pubkey = regenerate(offset).pubkey + old pubkey
            *                      = offset * G + 1 * old pubkey ?! */
           public_key add( const fcrypto::sha256& offset )const;
        ...
        private:
          ...
          fjson::fwd<detail::public_key_impl,33> my;
    };
    ...
    class private_key
    {
        public:
           ...
           static private_key regenerate( const fcrypto::sha256& secret );

           private_key child( const fcrypto::sha256& offset )const;
            ...
            */
           static private_key generate_from_seed( const fcrypto::sha256& seed, const fcrypto::sha256& offset = fcrypto::sha256() );
            ...
            */
           fcrypto::sha512 get_shared_secret( const public_key& pub )const;

//           signature         sign( const fcrypto::sha256& digest )const;
           compact_signature sign_compact( const fcrypto::sha256& digest, bool require_canonical = true )const;
//           bool              verify( const fcrypto::sha256& digest, const signature& sig );
        ...
        private:
           ...
           static fcrypto::sha256 get_secret( const EC_KEY * const k );
           fjson::fwd<detail::private_key_impl,32> my;
    };
    ...
    class extended_public_key : public public_key
    {
        public:
            ...
            fjson::string str() const;
            fjson::string to_base58() const { return str(); }
            static extended_public_key from_base58( const fjson::string& base58 );
    ...
    class extended_private_key : public private_key
    {
        public:
            ...
            fjson::string str() const;
            fjson::string to_base58() const { return str(); }
            static extended_private_key from_base58( const fjson::string& base58 );
            static extended_private_key generate_master( const fjson::string& seed );
            ...
            blinded_hash blind_hash( const fcrypto::sha256& hash, int i ) const;
            ...
            compact_signature unblind_signature( const extended_public_key& bob,
                                                 ...
                                                 const fcrypto::sha256& hash, int i ) const;

        private:
            extended_private_key private_derive_rest( const fcrypto::sha512& hash,
                                                      int num ) const;
  ...
  namespace raw
  {
      ...
      void unpack( Stream& s, fcrypto::ecc::public_key& pk)
      {
          ecc::public_key_data ser;
          fjson::raw::unpack(s,ser);
          pk = fcrypto::ecc::public_key( ser );
      }

      template<typename Stream>
      void pack( Stream& s, const fcrypto::ecc::public_key& pk)
      {
          fjson::raw::pack( s, pk.serialize() );
      }

      template<typename Stream>
      void unpack( Stream& s, fcrypto::ecc::private_key& pk)
      {
          fcrypto::sha256 sec;
          unpack( s, sec );
      ...
      template<typename Stream>
      void pack( Stream& s, const fcrypto::ecc::private_key& pk)
      {
          fjson::raw::pack( s, pk.get_secret() );
      }
...
FJSON_REFLECT_TYPENAME(fcrypto::ecc::private_key )
FJSON_REFLECT_TYPENAME(fcrypto::ecc::public_key )
FJSON_REFLECT(fcrypto::ecc::range_proof_info, (exp)(mantissa)(min_value)(max_value) )
